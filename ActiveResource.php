...
class ActiveResource {
	...
	function save () {
		if (isset ($this->_data['id'])) {
			return $this->_send_and_receive ($this->site . $this->element_name . '/' . $this->_data['id'] . '.'.$this->request_format, 'PUT', $this->_data); // update
		}
		return $this->_send_and_receive ($this->site . $this->element_name . '.'. $this->request_format, 'POST', $this->_data); // create
	}
